...
function Error() {
  return (
    <div className="max-w-[50rem] flex flex-col py-40 border-b dark:border-gray-700 mx-auto w-full h-full">
  ...
  <div className="text-center py-10 px-4 sm:px-6 lg:px-8">
    <h1 className="block text-7xl font-bold text-slate-900 sm:text-9xl dark:text-white">
      404
    </h1>
