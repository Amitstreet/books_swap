              ...
              <div className="mt-5">
                ...
                <form  onSubmit={submit}>
                  ...
                  <div>
                    ...
                    >
                     {loader==false ? "Sign up" :<div class=" w-4 h-4 animate-spin inline-block  size-6 border-[3px] border-current border-t-transparent text-gray-800 rounded-full dark:text-white" role="status" aria-label="loading">
