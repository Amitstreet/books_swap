...
function Index() {
  ...
  <div className="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto my-4 sm:my-10">
    <div className="sm:w-11/12 lg:w-3/4 mx-auto">
      {/* Card */}
      <div className="flex flex-col p-4 sm:p-10 bg-white shadow-md rounded-xl dark:bg-slate-900">
        {/* Grid */}
        <div className="flex justify-between">
          ...
          <div className="text-right">
            <h2 className="text-2xl md:text-3xl font-semibold text-slate-900 dark:text-gray-200">
              Invoice #
            </h2>
            <span className="mt-1 block text-gray-500">3682303</span>
            <address className="mt-4 not-italic text-slate-900 dark:text-gray-200">
              45 Roker Terrace
              <br />
              Latheronwheel
              <br />
        ...
        <div className="mt-8 grid sm:grid-cols-2 gap-3">
          <div>
            <h3 className="text-lg font-semibold text-slate-900 dark:text-gray-200">
              Bill to:
            </h3>
            <h3 className="text-lg font-semibold text-slate-900 dark:text-gray-200">
              Sara Williams
          ...
          <div className="sm:text-right space-y-2">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-1 gap-3 sm:gap-2">
              <dl className="grid sm:grid-cols-5 gap-x-3">
                <dt className="col-span-3 font-semibold text-slate-900 dark:text-gray-200">
                  Invoice date:
                </dt>
          ...
          <div className="border border-gray-200 p-4 rounded-lg space-y-4 dark:border-gray-700">
            ...
            <div className="grid grid-cols-3 sm:grid-cols-5 gap-2">
              <div className="col-span-full sm:col-span-2">
                ...
                <p className="font-medium text-slate-900 dark:text-gray-200">
                  Design UX and UI
                </p>
              </div>
              <div>
                ...
                <p className="text-slate-900 dark:text-gray-200">1</p>
              </div>
              <div>
                <h5 className="sm:hidden text-xs font-medium text-gray-500 uppercase">
                  Rate
                </h5>
                <p className="text-slate-900 dark:text-gray-200">5</p>
              </div>
              <div>
                <h5 className="sm:hidden text-xs font-medium text-gray-500 uppercase">
                  Amount
                </h5>
                <p className="sm:text-right text-slate-900 dark:text-gray-200">
                  $500
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 sm:grid-cols-5 gap-2">
              ...
              <div>
                ...
                <p className="text-slate-900 dark:text-gray-200">24</p>
              </div>
              <div>
                <h5 className="sm:hidden text-xs font-medium text-gray-500 uppercase">
                  Amount
            ...
            <div className="grid grid-cols-3 sm:grid-cols-5 gap-2">
              ...
              <div>
                ...
                <p className="text-slate-900 dark:text-gray-200">6</p>
              </div>
              <div>
                <h5 className="sm:hidden text-xs font-medium text-gray-500 uppercase">
                  Amount
        ...
        <div className="mt-8 sm:mt-12">
          <h4 className="text-lg font-semibold text-slate-900 dark:text-gray-200">
            Thank you!
          </h4>
          ...
          <div className="mt-2">
            <p className="block text-sm font-medium text-slate-900 dark:text-gray-200">
              example@site.com
            </p>
            <p className="block text-sm font-medium text-slate-900 dark:text-gray-200">
              +1 (062) 109-9222
      ...
      <div className="mt-6 flex justify-end gap-x-3">
        <a
          className="inline-flex justify-center items-center gap-x-3 text-sm text-center border hover:border-gray-300 shadow-sm font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-white transition py-3 px-4 dark:border-slate-900 dark:hover:border-gray-600 dark:shadow-slate-700/[.7] dark:text-white dark:focus:ring-gray-700 dark:focus:ring-offset-slate-900"
          href="#"
        >
          <svg
            className="w-4 h-4"
